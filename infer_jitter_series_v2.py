...
the image with the highest contrast infers the jitter
...
fname='D14-45403-50000_cam%g'%cam#'series_jitter_2024_07_14_wfe_corrected #Data file
ext='.fits'#'.npy' #Extention of the data file
txtname='PD_14_7_13_07_cam_0_52502_ima_1'
txtfolder=dir_folder +'txt/' #Path of the txt files
