...
flats_mode1_index = "D10-2740-4339" #Mode 1
flats_mode2_index = "D10-4340-5619" #Mode 2.02
...
# Start by computing master dark: [cam, dimx, dimy]
...
# Select continuum wavelength and modulation 0 for PD and normalize [cam, dimx, dimy]
...
for cam in range(2):
    pd_data_fe[cam,:] = (pd_data_fe[cam,:]-dc[cam,:])/ff_2[cam,:]
    pd_data_mg[cam,:] = (pd_data_mg[cam,:]-dc[cam,:])/ff_1[cam,:]
