"""
This program checks the noise level of the modulated images for the two
...
fname='modulations_COMM1_52502_ffielded_avgflat'#"modulations_COMM1_52502_ffielded_avgflat" #Data file
